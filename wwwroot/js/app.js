...
const generatePattern = (hue) => {
    ...
    const svg = `<svg xmlns='http://www.w3.org/2000/svg' width='800' height='1600' viewBox='0 0 800 1600'>
        <rect width='100%' height='100%' fill='hsl(${hue}, 30%, 10%)'/>
        ${shapes}
    </svg>`;

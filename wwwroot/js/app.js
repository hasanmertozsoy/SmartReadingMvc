...
const translate = (lang, key) => {
    const dictionary = {
        tr: {
            ...
            mute: "Sessize Al", unmute: "Sesi Aç", close: "Kapat", addNote: "Not Ekle",
            toggleFav: "Favorile", delete: "Sil", lightMode: "Açık Mod", darkMode: "Koyu Mod"
        },
        en: {
            ...
            mute: "Mute", unmute: "Unmute", close: "Close", addNote: "Add Note",
            toggleFav: "Toggle Favorite", delete: "Delete", lightMode: "Light Mode", darkMode: "Dark Mode"
        }
    };
        ...
        >
            ...
            <div className={`absolute top-0 right-0 p-4 pt-[calc(env(safe-area-inset-top)+3.5rem)] transition-opacity duration-300 ${showControls && !isPaused && !isBreakMode ? 'opacity-100' : 'opacity-0'} pointer-events-none`}>
                <div className="flex flex-col items-end gap-2">
                    ...
                    <button aria-label={isMuted ? translate(settings.language, 'unmute') : translate(settings.language, 'mute')} onClick={(e) => { e.stopPropagation(); setIsMuted(!isMuted); }} className="p-3 bg-black/50 rounded-full text-white pointer-events-auto hover:bg-white/20">
                ...
                <>
                    ...
                    <header className="px-5 py-4 pb-4 pt-[calc(env(safe-area-inset-top)+2.5rem)] flex-none flex justify-between items-center z-50 border-b border-gray-500/10 backdrop-blur-md bg-opacity-80" style={{ backgroundColor: 'var(--bg)' }}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button aria-label={isFullscreen ? translate(settings.language, 'minimize') : translate(settings.language, 'maximize')} onClick={() => { if (!document.fullscreenElement) document.documentElement.requestFullscreen(); else document.exitFullscreen(); }} className="p-2 opacity-70 hover:opacity-100">

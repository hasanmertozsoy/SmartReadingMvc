...
const translate = (lang, key) => {
    const dictionary = {
        tr: {
            ...
            close: "Kapat", mute: "Sessize Al", unmute: "Sesi Aç", fullscreen: "Tam Ekran", exitFullscreen: "Tam Ekrandan Çık",
            delete: "Sil", favorite: "Favori", unfavorite: "Favorilerden Çıkar"
        },
        en: {
            ...
            close: "Close", mute: "Mute", unmute: "Unmute", fullscreen: "Fullscreen", exitFullscreen: "Exit Fullscreen",
            delete: "Delete", favorite: "Favorite", unfavorite: "Unfavorite"
        }
    };
            ...
            <div className={`absolute top-0 right-0 p-4 pt-[calc(env(safe-area-inset-top)+3.5rem)] transition-opacity duration-300 ${showControls && !isPaused && !isBreakMode ? 'opacity-100' : 'opacity-0'} pointer-events-none`}>
                <div className="flex flex-col items-end gap-2">
                    ...
                    <button
                        ...
                        aria-label={translate(settings.language, activeNoteRef.current.sentences.find(s => s.id === queue[currentIndexRef.current]?.id)?.isFavorite ? 'unfavorite' : 'favorite')}
                        className="p-3 bg-black/50 rounded-full text-white pointer-events-auto hover:bg-white/20"
                    >
